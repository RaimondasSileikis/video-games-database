...
export default function GamesCategory({categoryStatus, setCategoryStatus}){
    ...
    return(
        ...
        <Link className="text-link" to="/adventure" onClick={changeCategoryStatus}>Adventure</Link>
        ...
        <Link className="text-link" to="/shooter" onClick={changeCategoryStatus}>Shooter</Link>
